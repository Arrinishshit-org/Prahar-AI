      ...
      <section className="relative overflow-hidden px-4 py-12 md:py-20 bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-2xl bg-gradient-to-br from-primary/20 to-primary/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/70">
                <li><button onClick={() => navigate('/')} className="hover:text-white transition-colors">How it works</button></li>
                <li><button onClick={() => navigate('/schemes')} className="hover:text-white transition-colors">Browse Schemes</button></li>
