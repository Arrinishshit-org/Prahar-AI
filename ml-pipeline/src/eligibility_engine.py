...
class EligibilityEngine:
    ...
    def generate_explanation(
        ...
        if category == 'highly_eligible':
            ...
            summary = f"You are potentially eligible for this scheme with a {percentage:.1f}% match."
        else:
    ...
    def _extract_scheme_vector(self, scheme: Dict[str, Any]) -> np.ndarray:
        ...
        scheme_profile = {
            ...
            'employment_status': self._get_first_or_default(eligibility.get('employment_status'), 'employed'),
            'education_level': self._get_first_or_default(eligibility.get('education_levels'), 'secondary'),
    ...
    def _generate_recommendations(
        ...
        for criterion in unmet_criteria:
            ...
            if name == 'age':
                ...
                recommendations.append(
                    "Explore schemes targeted at your occupation category"
                )
        
        if not recommendations:
            recommendations.append(
                "You meet most criteria for this scheme. Consider applying!"
            )
